...
impl Component {
    ...
    pub fn delta(&self, ivs: &ItemVariationStore, coords: &[NormalizedCoord]) -> Option<Fixed> {
        use crate::var::item::Index;
        self.delta_indices
            .map(|[outer, inner]| ivs.delta(Index::new(outer, inner), coords))
    }
}
